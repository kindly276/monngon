...
public class ListCookingAdapter extends RecyclerView.Adapter {

    private List<Cooking> MessageList;
    private MainActivity activity;

    public ListCookingAdapter(List<Cooking> Messages, MainActivity activity) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HeaderViewHolder) {
            ...
            ((HeaderViewHolder) holder).txt_material_name.setText(singleMessage.getName_cooking_type());
        }
    }
